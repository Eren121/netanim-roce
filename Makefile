...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Jun 15 07:30:49 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/newcanvas11.0.0/ && $(COPY_FILE) --parents myview.h log.h fatal-error.h fatal-impl.h abort.h assert.h logqt.h animatorconstants.h resizeablepixmap.h resizeableitem.h animnode.h common.h animatorscene.h .tmp/newcanvas11.0.0/ && $(COPY_FILE) --parents testrc.qrc .tmp/newcanvas11.0.0/ && $(COPY_FILE) --parents main.cpp myview.cpp log.cpp fatal-error.cpp fatal-impl.cpp logqt.cpp resizeablepixmap.cpp resizeableitem.cpp animnode.cpp animatorscene.cpp .tmp/newcanvas11.0.0/ && (cd `dirname .tmp/newcanvas11.0.0` && $(TAR) newcanvas11.0.0.tar newcanvas11.0.0 && $(COMPRESS) newcanvas11.0.0.tar) && $(MOVE) `dirname .tmp/newcanvas11.0.0`/newcanvas11.0.0.tar.gz . && $(DEL_FILE) -r .tmp/newcanvas11.0.0
