...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Dec 8 11:10:30 2013
# Project:  NetAnim.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		qtpropertybrowser/src/qtbuttonpropertybrowser.cpp moc_animatorscene.cpp \
		moc_animpacket.cpp \
		moc_netanim.cpp \
